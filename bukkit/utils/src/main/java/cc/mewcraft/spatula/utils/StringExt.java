package cc.mewcraft.spatula.utils;
...
public class StringExt {
    ...
    public static final char SECTION_CHAR = LegacyComponentSerializer.SECTION_CHAR;
    ...
    /**
     * @deprecated in favor of {@link #colorize(String)}
     */
    @Deprecated
    @Contract(pure = true)
    ...
    @Deprecated
    @Contract()
    public static @NotNull List<String> colorize(@NotNull List<String> list) {
        list.replaceAll(StringExt::colorize);
        return list;
    }

    @Deprecated
    @Contract(pure = true)
    public static @NotNull Set<String> colorize(@NotNull Set<String> list) {
        return new HashSet<>(colorize(new ArrayList<>(list)));
    }
    ...
    public static @NotNull String extractCommandName(@NotNull String cmd) {
        String cmdFull = stripColor(cmd).split(" ")[0];
